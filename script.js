  ...
  $.ajax({
    ...
    for (i = 0; i < forecast.list.length; i++) {
      if (forecast.list[i].dt_txt.indexOf("18:00:00") !== -1) {
        ...
        var short = `<img src="https://images.unsplash.com/photo-1586363104862-3a5e2ab60d4d?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" width="80px" height="80px"/>`; // Casual T-shirt for warm weather
        var rainyDay = `<img src="https://images.unsplash.com/photo-1414604582943-2fd913b3cb4b?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" width="100px" height="100px"/>`; // Rainy street for rainy weather
        var coldDayCloud = `<img src="https://images.unsplash.com/photo-1580981785366-d5d97b729a58?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" width="100px" height="100px"/>`; // Misty forest for cold, cloudy days
        var coldDay = `<img src="https://images.unsplash.com/photo-1486946255434-2466348c2166?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" width="100px" height="100px"/>`; // Snowy scene for cold days
        var sunny = `<img src="https://images.unsplash.com/photo-1502082553048-f009c37129b9?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" width="100px" height="100px"/>`; // Clear sky for sunny days
        var umbrella = `<img src="https://images.unsplash.com/photo-1527761939622-9119094630cf?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" width="80px" height="80px"/>`; // Umbrella for rain
        var winter = `<img src="https://images.unsplash.com/photo-1516466723877-e4ec1d736c8a?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" width="80px" height="80px"/>`; // Frosty scene for winter conditions
